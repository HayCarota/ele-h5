    ...
    <OpLoadingView :loading="pending" type="skeleton">
        ...
        <div class="me-page__card" v-for="v in data.cards" :key="v.label">
            ...
            <div class="me-page__card__items">
                <div class="me-page__cards__item" v-for="cv in v.items" :key="cv.iconUrl">
                    <VanIcon v-if="v.label !== '更多推荐'" :name="`src/assets/api${cv.iconUrl}`" :size="v.size"></VanIcon>
                    <VanIcon v-else :name="cv.iconUrl" :size="v.size"></VanIcon>
                    <div class="label">{{ cv.label }}
